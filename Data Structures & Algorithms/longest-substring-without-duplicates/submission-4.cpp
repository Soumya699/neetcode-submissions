...
//     }
// };
// // TC= O(n),ALTHOUGH THERE IS  NESTED LOOP,BECAUSE EVERY CHARACTERS ENTER THE WINDOW AT MOST ONCE AND LEAVES THE WINDOW AT MOST ONCE.LEFT DOES NOT LOOKS BACKWARD ELEMENT AND RIGHT ALSO NEVER LOOKS BACKWARD ELEMENT
